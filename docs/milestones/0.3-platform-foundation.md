...
| | |
|--|--|
| Version | Shipped inside `0.1.0` (`198c237`); no `0.3.x` pom bump |
| Commit | `198c237` — initial platform backend (persistence + REST + history foundations) |
...
## Scope (verified in `198c237` / still present)
